# Warren Dalawampu — Portfolio Documentation Index

Welcome to the technical documentation hub for the **Warren Dalawampu** developer portfolio.

## Navigation Hub
- [Architecture Specification](ARCHITECTURE.md): Full tech stack, design system tokens (`awesome-design` Linear Dark Craft), layout mechanics, and component hierarchy.
